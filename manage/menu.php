...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-link"><a href="<?php echo(getBaseDir()); ?>/manage/users.php" class="nav-link">Users</a></li>
        ...
        <li class="nav-link"><a href="<?php echo(getBaseDir()); ?>/manage/logout.php" class="nav-link">Log Out</a></li>
    </ul>
</nav>
<?php } ?>